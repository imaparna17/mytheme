...
//=============================================================
function mitra_register_required_plugins() {
	
	$plugins = array(
				
		array(
			'name'      => esc_html__( 'Elementor Page Builder', 'mitra' ),
			'slug'      => 'elementor',
			'required'  => false,
		),

		array(
			'name'      => esc_html__( 'Post Grid Elementor Addon', 'mitra' ),
			'slug'      => 'post-grid-elementor-addon',
			'required'  => false,
		),

		array(
			'name'      => esc_html__( 'Instagram Feed For Elementor', 'mitra' ),
...
add_action( 'tgmpa_register', 'mitra_register_required_plugins' );