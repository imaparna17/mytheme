...
$wp_customize->add_section( 'page_option_section_settings',
	array(
		...
		$wp_customize->add_section( 'demo_content',
			array(
			'title'      => esc_html__( 'Import demo content', 'diet-shop' ),
			'capability' => 'edit_theme_options',
			'panel'      => 'theme_option_panel',
			)
		);
		...
		$wp_customize->add_control( new diet_shop_Demo_Content_Import( $wp_customize, 'textarea_setting', array(
			'description' => esc_html__( 'Import your favorite site with one click and start your project in style!', 'diet-shop' ),
